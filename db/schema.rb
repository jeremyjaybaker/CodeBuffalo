...
ActiveRecord::Schema.define(version: 2019_06_15_182312) do
  ...
  create_table "budget_types", id: :serial, force: :cascade do |t|
    ...
    t.index ["name"], name: "budget_types_name_key", unique: true
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "interest_categories", default: [], null: false, array: true
    t.integer "budget_type_id", default: 4
